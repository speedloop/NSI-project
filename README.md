...
Génération du donjon : salles précréées (codées en texte) piochées aléatoirement lorsque le personnage entre dans une nouvelle salle en fonction de sa position (coint, bord, milieu...)<br> (Tout ça priorité haute)
...
Ennemis : différents ennemis avec différentes statistiques (variables et textures), points de vie (comme personnage), drop (non prioritaire), apparaissent dans les salles semi aléatoirement, quand on rentre dans la salle (point de spawn donnés possibles, le programe choisit les emplacement ou il y aura un monste àléatoirement)(priorité haute sur ça)<br>
